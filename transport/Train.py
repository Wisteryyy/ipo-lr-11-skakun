...
class Train(Vehicle):
    def __init__(self, capacity, number_of_cars):
        ...
        if isinstance(number_of_cars, (int)) or number_of_cars < 0:
            raise ValueError("Количество вагонов должно быть положительным целочисленным числом.")
        
        self.number_of_cars = number_of_cars

    def __str__(self):
        first_str = super().__str__()
        return f"{first_str}, Количество вагонов: {self.number_of_cars}"